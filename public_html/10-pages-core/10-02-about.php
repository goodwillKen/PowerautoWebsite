...
// Note: Inline styles removed; logic moved to assets/css/style.css
// Note: Inline JS removed; logic moved to assets/js/carousel.js
...
?>
    ...
    <section class="page-hero relative bg-gray-700">
        <!-- New Image Path -->
        <img src="assets/images/hero/01-02-about-hero.webp" alt="About Powerauto Hydraulics" class="banner-image" onerror="this.onerror=null; this.src='https://placehold.co/3800x550/3D4852/F7FAFC?text=About+Powerauto';">
                ...
                <div class="flex flex-col lg:flex-row items-start gap-12">
                    <div class="lg:w-3/5">
                        ...
                        <div class="flex flex-wrap gap-3 mt-8">
                            ...
                            <a href="3-contact.php?reason=general" class="flex-1 sm:flex-none group flex items-center justify-center py-3 px-6 bg-red-600 hover:bg-red-700 text-white rounded-lg transition duration-300" title="Contact Form">
                    ...
                    <div class="lg:w-2/5">
                        <div class="sticky top-24 space-y-6">
                            <!-- New Image Path -->
                            <img src="assets/images/misc/Powerauto-about.webp" alt="Powerauto Hydraulics Workshop" class="rounded-lg shadow-xl w-full" onerror="this.onerror=null; this.src='https://placehold.co/600x400/CCCCCC/4A4A4A?text=Workshop+View';">
