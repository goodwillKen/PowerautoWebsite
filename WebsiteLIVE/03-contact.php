...
?>
    ...
    <!-- Page Hero / Banner -->
    <section class="relative bg-gray-700 bg-cover bg-center h-64 md:h-96" style="background-image: url('assets/images/hero/01-04-contact-hero.webp');">
    ...
    // Expose closeSuccessModal to global scope for button onclick
