<?php 
$pageTitle = "Filtration - Powerauto Hydraulics";
$activePage = "products";
...
?>
    ...
    <section class="page-hero">
        <img src="images/FILTERScategory1200x1200.png" class="w-full h-full object-cover opacity-60 blur-sm" onerror="this.src='https://placehold.co/1920x400/374151/FFFFFF?text=Filtration'">
        <div class="hero-overlay">
            <div class="text-center text-white px-4">
                <h1 class="text-4xl md:text-5xl font-bold mb-2">Filtration</h1>
                <div class="text-sm md:text-base text-gray-300">
                    <a href="products.php" class="hover:text-white underline">Products</a> <i class="fas fa-chevron-right mx-2 text-xs"></i> <span>Filters</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <main class="py-12 md:py-16 bg-white flex-grow">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-12">
                <h2 class="text-3xl font-bold text-gray-800 mb-4 border-b border-gray-200 pb-2">System Protection</h2>
                <p class="text-gray-600 leading-relaxed max-w-4xl">
                    Protect your hydraulic components and maintain fluid cleanliness with Powerauto Hydraulics’ filtration solutions. We supply high-pressure filters for demanding applications, convenient spin-on filters for suction and return lines, and tank-top return filters.
                </p>
            </div>

            <div class="mb-16">
                <?php 
                if (isset($catalog['filtration'])) {
                    renderProductCatalog($catalog['filtration']); 
                }
                ?>
            </div>
        </div>
