...
?>
    ...
    <section class="page-hero">
        <img src="images/PUMPScategory1200x1200.png" class="w-full h-full object-cover opacity-60 blur-sm" onerror="this.src='https://placehold.co/1920x400/374151/FFFFFF?text=Pumps+Banner'">
        <div class="hero-overlay">
            <div class="text-center text-white px-4">
                ...
                <div class="text-sm md:text-base text-gray-300">
                    <a href="products.php" class="hover:text-white underline">Products</a> <i class="fas fa-chevron-right mx-2 text-xs"></i> <span>Pumps</span>
                </div>
            </div>
        </div>
    </section>
