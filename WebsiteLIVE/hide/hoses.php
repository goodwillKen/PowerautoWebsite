<?php 
$pageTitle = "Hoses & Fittings - Powerauto Hydraulics";
$activePage = "products";
...
?>
    ...
    <section class="page-hero">
        <img src="images/HoseCouplingFittingscategory1200x1200.png" class="w-full h-full object-cover opacity-60 blur-sm" onerror="this.src='https://placehold.co/1920x400/374151/FFFFFF?text=Hoses'">
        <div class="hero-overlay">
            <div class="text-center text-white px-4">
                <h1 class="text-4xl md:text-5xl font-bold mb-2">Hoses & Fittings</h1>
                <div class="text-sm md:text-base text-gray-300">
                    <a href="products.php" class="hover:text-white underline">Products</a> <i class="fas fa-chevron-right mx-2 text-xs"></i> <span>Hoses</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <main class="py-12 md:py-16 bg-white flex-grow">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-12">
                <h2 class="text-3xl font-bold text-gray-800 mb-4 border-b border-gray-200 pb-2">Connect & Seal</h2>
                <p class="text-gray-600 leading-relaxed max-w-4xl">
                    Connect your hydraulic system components securely with Powerauto Hydraulics’ range of hoses, fittings, and couplings. We offer industry-standard quick-release couplings, hydraulic hose assemblies, and a wide variety of fittings.
                </p>
            </div>

            <div class="mb-16">
                <?php 
                if (isset($catalog['hoses'])) {
                    renderProductCatalog($catalog['hoses']); 
                }
                ?>
            </div>
        </div>
